...
class ConsulActivityActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_consul_activity)
        ...
        findViewById<TextView>(R.id.nameTextView).text = "Socio ID: $id - Nombre: $nombre $apellido"
    ...
    private fun listActivities() {
        ...
        val list = dbHelper.getRegisteredAct(id)
